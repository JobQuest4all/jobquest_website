...
module.exports = function(config) {
  config.set({
    ...
    files: [
        ...
        { pattern: '../main/resources/public/app/core/core.module.js', watched: false},
        { pattern: '../main/resources/public/app/core/people/people.module.js', watched: false},
        { pattern: '../main/resources/public/app/core/settings/settings.module.js', watched: false},
        { pattern: '../main/resources/public/app/core/settings/contextpath.value.js', watched: false},
        { pattern: 'resources/public/app/core/settings/domain.value.js', watched: false},
        { pattern: 'resources/public/app/core/settings/port.value.js', watched: false},
        { pattern: 'resources/public/app/core/settings/scheme.value.js', watched: false},
        { pattern: '../main/resources/public/app/core/settings/baseUrl.factory.js', watched: false},
